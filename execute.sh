...
VALIDATOR_BALANCE=456734598243569
echo "VALIDATOR_BALANCE: $VALIDATOR_BALANCE"

VALIDATOR_DIVISION_BALANCE=$(($(($VALIDATOR_BALANCE - 100000000)) / $DIVIDED_RANDOM))
...
do
	...
	submitTransactionFunc $VALIDATOR_ADDR $DIVIDED_ADDR $VALIDATOR_DIVISION_BALANCE true $MSIG_KEYS_JSON_PATH
	sleep $((RANDOM% 61 + 60))
	confirmTransactionFunc $DIVIDED_ADDR
	sleep $((RANDOM% 3600))
done
